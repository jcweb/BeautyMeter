...
import cn.yaman.utils.LinearGradient;
...
public class WheelPicker<T> extends View {
    ...
    private void initAttrs(Context context, @Nullable AttributeSet attrs) {
        ...
        mTextSize = a.getDimensionPixelSize(
                R.styleable.WheelPicker_itemTextSize,
                getResources().getDimensionPixelSize(R.dimen.WheelItemTextSize));
        mTextColor = a.getColor(
                R.styleable.WheelPicker_itemTextColor,
                Color.BLACK);
        ...
        mItemHeightSpace = a.getDimensionPixelSize(
                R.styleable.WheelPicker_itemHeightSpace,
        ...
        mCurtainColor = a.getColor(
                R.styleable.WheelPicker_wheelCurtainColor,
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        setMeasuredDimension(
                measureSize(specWidthMode, specWidthSize, width),
